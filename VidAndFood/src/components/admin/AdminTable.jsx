  ...
  return (
    <Card className="mb-4 shadow-sm border-0">
      <Card.Body>
        ...
        {!loading && !error && (
          <>
            <Table responsive hover size="sm" className="mb-2 admin-table">
              <thead>
                <tr>
                  {columns.map((col, idx) => (
                  ...
                  pageData.map((row, rowIndex) => {
                    ...
                    return (
                      <tr
                        key={id ?? rowIndex}
                        onClick={
                          isSelectable ? () => onRowSelect(row) : undefined
                        }
                      ...
                      >
                        {columns.map((col, colIndex) => (
                          <td key={colIndex} className={col.className} style={col.style} >{col.accessor(row)}</td>
                        ))}
                      </tr>
                    );
                  })
